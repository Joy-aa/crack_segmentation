...
if __name__ == '__main__':
    model_path = '/home/wj/local/crack_segmentation/GSCNN/checkpoints/fineSeg/model_best.pt'
    # #dam
    ...
    ignore_list=['creak_s19', 'creak_s30', "creak_s66"]
