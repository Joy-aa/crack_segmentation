...
if __name__ == '__main__':
    ...
    # /nfs/DamDetection/data/  /mnt/hangzhou_116_homes/DamDetection/data/  /home/wj/dataset/crack/ /mnt/ningbo_nfs_36/wj/data/
    parser.add_argument('--img_dir',type=str, default='../images', help='input dataset directory')
    parser.add_argument('--model_path', type=str, default='./log/dfanet20230719T1622/model_dfanet_0002.pt', help='trained model path')
