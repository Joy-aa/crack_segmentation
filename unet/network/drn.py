...
#import SynchronizedBatchNorm2d
...
class DRN(nn.Module):
    ...
    def forward(self, x):
        ...
        return x, low_level_feat, boundary
...
if __name__ == "__main__":
    import torch
    model = drn_d_105(BatchNorm=nn.BatchNorm2d, pretrained=False)
    input = torch.rand(4, 3, 400, 400)
    output, low_level_feat ,boundary= model(input)
    print(output.size())
